...
import { XMarkIcon, PaperAirplaneIcon, ChevronLeftIcon, UsersIcon, ChatBubbleLeftRightIcon } from '@heroicons/react/24/outline';
                    ...
                    >
                        ...
                        <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between bg-white/[0.02]">
                            <div className="flex items-center gap-4">
                                ...
                                />
                                <div>
                                    <h3 className="font-bold text-white text-lg leading-tight">{openChat?.displayName}</h3>
                        ...
                        <div ref={scrollRef} className="flex-1 overflow-y-auto p-6 space-y-4 custom-scrollbar bg-gradient-to-b from-transparent to-white/[0.01]">
                            {messages.length === 0 ? (
                                ...
                                messages.map((msg, i) => {
                                    ...
                                    // Message fields are top-level (spread from content)
                                                ...
                                                {msgType === 'movie_share' ? (
                                                    <div className="space-y-2">
                                                        <div className="bg-black/20 p-2 rounded-xl flex items-center gap-3 border border-black/10">
                                                            {msg.movie?.poster_path && (
                                                                <img
                                                                    src={`https://image.tmdb.org/t/p/w92${msg.movie.poster_path}`}
                                                                    className="w-12 rounded-md shadow-inner"
                                                                    alt=""
                                                                />
                                                            )}
                                                            <div className="truncate">
                                                                <p className="font-bold text-xs truncate uppercase">{msg.movie?.title}</p>
                                                    ...
                                                    <div className="space-y-2">
                                                        <div className="bg-black/20 p-3 rounded-xl flex items-center gap-3 border border-black/10">
                                                            ...
                                                            <div className="truncate">
                                                                <p className="font-bold text-xs truncate uppercase">{msg.list?.name}</p>
