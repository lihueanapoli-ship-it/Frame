            ...
            {isOpen && (
                <div className="fixed inset-0 z-[300] flex items-end sm:items-center justify-center sm:p-4" onClick={onClose}>
                    ...
                    <motion.div
                        ...
                        className="relative z-10 w-[calc(100%-2rem)] sm:w-full max-w-7xl bg-[#0F0F0F] border border-white/10 rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col h-[92vh] sm:h-[94vh] my-auto"
                    >
                        {/* Header */}
