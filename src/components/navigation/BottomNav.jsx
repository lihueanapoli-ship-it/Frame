...
const BottomNav = () => {
    ...
    return (
        <nav className="fixed bottom-0 left-0 right-0 z-[200] bg-background/80 backdrop-blur-xl border-t border-white/5 pb-safe md:hidden shadow-[0_-8px_32px_rgba(0,0,0,0.5)]">
