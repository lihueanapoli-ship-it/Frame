                ...
                {activeTab === 'friends' && (
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {friends.length === 0 ? (
                            ...
                            friends.map(friend => (
                                <div key={friend.uid} className="flex items-center gap-4 p-4 bg-surface-elevated border border-white/5 rounded-xl hover:border-white/20 transition-all group">
...
// Necesitamos importar setDoc también al principio
