...
const ListView = ({ onSelectMovie }) => {
    ...
    const handleInvite = async () => {
        const collaboratorId = prompt("Ingresa el ID del usuario a invitar (Temporal - busca en la URL de su perfil):");
        if (collaboratorId) {
            await addCollaborator(id, collaboratorId);
            alert("Usuario invitado. Ahora podrá ver y editar esta lista.");
        }
    };
